...
public class CommentLevelIdentity {
	private int id;
	...
	private List<CommentIdentity> commentList;
	...
	public List<CommentIdentity> getCommentList() {
		return commentList;
	}
	public void setCommentList(List<CommentIdentity> commentList) {
